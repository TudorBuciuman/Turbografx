...
public class PlayerStats : MonoBehaviour
{
    ...
    private float widthIncreasePerLevel = 1.3f; 
    ...
    public void Start()
    {
        ...
        baseHealthBarWidth = hpSliderRect.sizeDelta.x;
        widthIncreasePerLevel = baseHealthBarWidth / 5.0f;
    ...
    public void ResizeHealthBar()
    {
        ...
        {
            float newWidth = baseHealthBarWidth + (widthIncreasePerLevel * (level-1));
